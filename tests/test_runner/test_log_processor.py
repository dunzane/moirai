...
from pipeai.device import is_cuda_available
from pipeai.device.available import is_musa_available
from pipeai.logging.message_hub import MessageHub
from pipeai.runner import LogProcessor
from pipeai.logging import get_logger, HistoryBuffer
...
class TestLogProcessor(unittest.TestCase):
    ...
    def setUp(self):
        ...
        logger = get_logger('log_processor_test')
        runner.logger = logger
        message_hub = MessageHub('log_processor_test')
        for i in range(10):
    ...
    def test_collect_scalars(self):
        ...
        history_loss_cls = HistoryBuffer(loss_cls_scalars, history_count)
        ...
        tag = log_processor._collect_scalars(
            copy.deepcopy(custom_cfg), self.runner, stage='val')
    ...
    def test_collect_non_scalars(self):
        ...
        tag = log_processor._collect_non_scalars(self.runner, stage='test')
